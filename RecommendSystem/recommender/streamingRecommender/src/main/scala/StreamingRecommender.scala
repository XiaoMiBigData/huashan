...
object ConnHelper {
  lazy val jedis = new Jedis("192.168.1.126")
  lazy val mongoClient = MongoClient(MongoClientURI("mongodb://192.168.1.126:27017/recom"))
}


/**
  * Created by root on 2020/04/30
  * author:Jackson
  *
  * 实时推荐引擎.
  *
...
object StreamingRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val kafkaPara = Map(
      "bootstrap.servers" -> "192.168.1.126:9092",
